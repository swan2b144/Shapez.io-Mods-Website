(() => {
                            ...
                            if (e.hasOwnProperty(n))
                                if ("bool" === e[n].type) {
                                    const a = new o(
                                        ...
                                        e[n].description,
                                        (t) => {
                                            (e[n].value = t), shapezAPI.mods.get(c.modId).updateStaticSettings();
                                        },
                                        () => e[n].enabled()
                                    );
    ...
    (() => {
        const { AboutModsState: t } = n(90), { ModsState: e } = n(405), { ModSettingsState: a } = n(848),
