    ...
    return {
        ...
        content: [
                          ...
                          play: () => {
                              ...
                              xhr.open(
                                  ...
                                  `/api/v1/database/users/${document
                                      .getElementById(
                                          `instance-var-${instanceName}-userId`
                                      )
                                      .getAttribute(`value`)}`,
                                  true
                              );
                              ...
                              xhr.onreadystatechange = async (e) => {
                                  if (
                                      ...
                                      if (!JSON.parse(e.target.response))
                                          return;
                                      localStorage.setItem(
                                          "user",
                                          e.target.response
            ...
            ...instance.modButtons,
            {
                post: {
                    title:
                        req.language.dashboard.instances.content.updateInstance
                            .post,
                    onChange: (languages, language, user) => async (button) => {
                        ...
                        let name = document.getElementById(
                            `instances-${instanceName}-updateName`
                        );
                        ...
                        let data = {};
                        data[`instances.${name.classList[0]}.name`] =
                            name.value;
                ...
                content: [
                    {
                        ...
                        value: instance.name,
                        title:
                            req.language.dashboard.instances.content
                                .updateInstance.fields.name,
                ...
                post: {
                    ...
                    onChange: (languages, language, user) => async (button) => {
                        let instanceName = document
                            .getElementsByClassName("category active")[0]
                            .id.split("-")[1];
                        let modid = document.getElementById(
                            `instances-${instanceName}-addMod`
                        );
                        ...
                        xhr.open(
                            `GET`,
                            `/api/v1/database/mods/${modid.value}`,
                            true
                        );
                        xhr.setRequestHeader(
                            `Content-Type`,
                        ...
                        xhr.onreadystatechange = async (e) => {
                            if (e.target.readyState === XMLHttpRequest.DONE) {
                                ...
                                data.$push = {};
                                data.$push[
                                    `instances.${modid.classList[0]}.mods`
                                ] = {
                ...
                content: [
                    {
                        ...
                        title:
                            req.language.dashboard.instances.content.addMod
                                .fields.id,
            ...
            },
            {
                post: {
                    red: true,
                    title:
                        req.language.dashboard.instances.content.deleteInstance
                            .post,
                    onChange: (languages, language, user) => async (button) => {
                        let instanceName = document
                            .getElementsByClassName("category active")[0]
