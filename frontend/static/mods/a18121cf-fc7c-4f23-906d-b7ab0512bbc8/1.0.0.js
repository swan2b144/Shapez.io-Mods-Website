(() => {
    var t = {
            517: (t, e, n) => {
                ...
                class a extends shapezAPI.exports.TextualGameState {
                    ...
                    getMainContentHTML() {
                        return `<div class="head"><div class="logo"><img src="${shapezAPI.exports.cachebust("res/logo.png")}" alt="shapez.io Logo"><span class="updateLabel">Mods</span></div></div><div class="text">${shapezAPI.translations.aboutMods.text}</div>`;
                    }
                    onEnter() {}
                }
            },
            245: (t, e, n) => {
                ...
                class o extends shapezAPI.exports.TextualGameState {
                    ...
                    getMainContentHTML() {
                        return `<div class="sidebar"><button class="styledButton categoryButton" data-category-btn="installedMods">${shapezAPI.translations.mods.categories.installedmods}</button><button class="styledButton categoryButton" data-category-btn="exploreMods">${
							shapezAPI.translations.mods.categories.exploreMods
						}</button><button class="styledButton categoryButton" data-category-btn="exploreModpacks">${shapezAPI.translations.mods.categories.exploreModpacks}</button><div class="other"><button class="styledButton aboutButton" data-category-btn="exploreModpacks">${
                    ...
                    getMods() {
                        let t = "";
                        for (const [e, n] of shapezAPI.mods) t += `<a class="setting cardbox enabled mod-settings-card-${e}"><div class="row"><label>${n.title}</label></div><div class="desc">${n.description}</div></a>`;
                        return t;
                    }
                    onEnter() {
                        this.htmlElement.querySelectorAll("a[href]").forEach((t) => {
                                this.trackClicks(t, () => this.app.platformWrapper.openExternalLink(t.getAttribute("href")), { preventClick: !0 });
                            }),
                    ...
                    initCategoryTrackClicks() {
                        const t = this.htmlElement.querySelector("[data-category-btn='installedMods']");
                        this.trackClicks(
                            t,
                            () => {
                        ...
                        const e = this.htmlElement.querySelector("[data-category-btn='exploreMods']");
                        this.trackClicks(
                            e,
                            () => {
                        ...
                        const n = this.htmlElement.querySelector("[data-category-btn='exploreModpacks']");
                        this.trackClicks(
                            n,
                            () => {
                                window.open("http://thomasbrants.nl/mods", "_blank").focus();
                        ...
                        for (const [t, e] of shapezAPI.mods)
                            ...
                            this.trackClicks(
                                ...
                                () => {
                                    (a.ModSettingsState.modId = t), this.moveToStateAddGoBack("ModSettingsState");
                                }, { preventClick: !0 }
                            );
                    }
                    setActiveCategory(t) {
                        ...
                        const a = this.htmlElement.querySelector("[data-category='" + t + "']"),
                            o = this.htmlElement.querySelector("[data-category-btn='" + t + "']");
                ...
                const s = (t) => ({
                    ...
                    text: t,
                    action: (t) => () => {
                        t.app.analytics.trackUiClick("create_mod"), shapezAPI.exports.generateFileDownload("Basic_mod_layout.js", "http://thomasbrants.nl:3000/mods/");
                    },
                });
                (o.setAPI = (t) => {
                    shapezAPI.exports.MainMenuState.extraTopButtons.push({ htmlClass: "mods-list-button", htmlData: "data-icon='main_menu/mods.png'" }),
                        ...
                        shapezAPI.mods.get(t).settings.hasMakeModButton.value && shapezAPI.exports.MainMenuState.extraSmallButtons.push(s(shapezAPI.translations.mainMenu.createMod));
                }),
                (o.updateStaticTranslations = (t, e) => {
                    shapezAPI.mods.get(t).settings.hasMakeModButton.value && (shapezAPI.exports.MainMenuState.extraSmallButtons.find((t) => "CreateModButton" === t.htmlClass).text = shapezAPI.translations.mainMenu.createMod);
                }),
                (o.updateStaticSettings = (t) => {
                    shapezAPI.mods.get(t).settings.hasMakeModButton.value ?
                        shapezAPI.exports.MainMenuState.extraSmallButtons.push(s(shapezAPI.translations.mainMenu.createMod)) :
                        shapezAPI.exports.MainMenuState.extraSmallButtons.splice(
                            shapezAPI.exports.MainMenuState.extraSmallButtons.findIndex((t) => "CreateModButton" === t.htmlClass),
                            1
                        );
                });
            },
            6: (t, e, n) => {
                ...
                class a {
                    constructor(t, e, n, a, o, s) {
                        (this.id = t), (this.changeCb = o), (this.enabledCb = s), (this.value = e), (this.title = n), (this.description = a);
                    }
                    getHtmlElement() {
                    ...
                    setup() {}
                    getHtml() {
                        return `<div class="setting cardbox ${this.getIsAvailable() ? "enabled" : "disabled"}"><div class="row"><label>${this.title}</label>${this.getTypeHtml()}</div><div class="desc">${this.description}</div></div>`;
                    }
                    getTypeHtml() {
                        return "";
                    }
                ...
                class o extends a {
                    ...
                    getTypeHtml() {
                        return `<div class="value checkbox ${this.value ? "checked" : ""}" data-mod-setting="${this.id}"><span class="knob"></span></div>`;
                    }
                    modify() {
                        (this.value = !this.value), this.getHtmlElement().classList.toggle("checked"), this.changeCb && this.changeCb(this.value);
                    }
                }
                class s extends a {
                    ...
                    modify(t) {
                        const { optionSelected: e } = t.showOptionChooser(this.title, { active: this.value, options: this.options.map((t) => ({ value: t, text: this.textGetter(t), desc: "", iconPrefix: null })) });
                        e.add((t) => {
                            let e = "???";
                            this.options.indexOf(t) >= 0 ? ((e = this.textGetter(t)), (this.value = t)) : console.warn("Setting value", t, "not found for", this.id, "!"), (this.getHtmlElement().innerHTML = e), this.changeCb && this.changeCb(this.value);
                        }, this);
                    }
                }
                class i extends a {
                    constructor(t, e, n, a, o, s, i, c, r) {
                        super(t, e, s, i, c, r), (this.min = n), (this.max = a), (this.stepSize = o);
                    }
                    getTypeHtml() {
                    ...
                    updateLabels() {
                        const t = Math.round(Number(100 * this.getHtmlElement().querySelector("input.rangeInput").value) / 100);
                        this.getHtmlElement().querySelector("label").innerText = t.toString();
                    }
                    setup() {
                        this.getHtmlElement()
                    ...
                    modify() {
                        (this.value = Math.round(Number(100 * this.getHtmlElement().querySelector("input.rangeInput").value) / 100)), this.changeCb && this.changeCb(this.value);
                    }
                }
                class c extends shapezAPI.exports.TextualGameState {
                    ...
                    getStateHeaderTitle() {
                        return shapezAPI.mods.get(c.modId).title + " " + shapezAPI.translations.settings.title;
                    }
                    getMainContentHTML() {
                            ...
                            if (e.hasOwnProperty(n))
                                if ("bool" === e[n].type) {
                                    const a = new o(
                                        ...
                                        e[n].description,
                                        (t) => {
                                            (e[n].value = t), this.updateSetting(n, t), shapezAPI.mods.get(c.modId).updateStaticSettings();
                                        },
                                        () => e[n].enabled()
                                    );
                    ...
                    updateSetting(t, e) {
                        ...
                        (n.mods[o].settings[t].value = e), localStorage.setItem("instance", JSON.stringify(n));
                        let s = {};
                        s[`instances.${a}.mods.${o}.settings.${t}.value`] = e;
                        let i = new XMLHttpRequest();
                        (i.withCredentials = !0), i.open("PATCH", `/api/v1/database/users`, !0), i.setRequestHeader("Content-Type", "application/json"), i.send(JSON.stringify(s));
                    }
                    onEnter() {
    ...
    (() => {
        const { AboutModsState: t } = n(517), { ModsState: e } = n(245), { ModSettingsState: a } = n(6),
        ...
        registerMod({
            ...
            dependencies: [],
            incompatible: [],
            settings: { hasMakeModButton: { type: "bool", value: !1, title: "Make mod button", description: "Enable/Disable the make mod button", enabled: () => !0 } },
            translations: {
                en: {
                    [o]: { description: "The mod that adds the mods list" },
                    modSettings: { title: "Mod settings" },
                    aboutMods: { title: "About mods", text: "This is a page about mods" },
                    mods: { title: "Mods", categories: { installedmods: "Installed mods", exploreMods: "Explore mods", exploreModpacks: "Explore modpacks" } },
                    mainMenu: { createMod: "Create a mod" },
                    settings: { labels: { hasMakeModButton: { title: "Make mod button", description: "Enable/Disable the make mod button" } } },
                },
                nl: {
                    ...
                    mods: { title: "Mods", categories: { installedmods: "Geïnstalleerde mods", exploreMods: "Verken mods", exploreModpacks: "Verken modpacks" } },
                    mainMenu: { createMod: "Maak een mod" },
                    settings: { labels: { hasMakeModButton: { title: "Maak een mod knop", description: "Schakel de make mod knop in/uit" } } },
                },
            },
            ...
            updateStaticTranslations: (t) => {
                shapezAPI.mods.get(o).description = shapezAPI.translations[o].description;
                for (let t = 0; t < shapezAPI.modOrder.length; t++) {
                    ...
                    for (const t in shapezAPI.mods.get(e).settings) {
                        ...
                        (n.title = shapezAPI.translations.settings.labels[t].title), (n.description = shapezAPI.translations.settings.labels[t].description);
                    }
                }
            ...
            main: (n) => {
                shapezAPI.injectCss(
                    ...
                    e.setAPI(o),
                    shapezAPI.exports.HUDSettingsMenu.buttons.splice(shapezAPI.exports.HUDSettingsMenu.buttons.findIndex((t) => "settings" === t.id) + 1, 0, { id: "mods", action: (t) => () => t.root.gameState.saveThenGoToState("ModsState", { backToStateId: t.root.gameState.key, backToStatePayload: t.root.gameState.creationPayload }), options: { preventDefault: !1 } });
            },
        });
    })();
})();