        ...
        post: {
          ...
          onChange: (languages, language, user) => async (button) => {
            ...
            let version = document.getElementById(
              `modpack-${modpackid}-version`
            );
            let gameversion = document.getElementById(
              `modpack-${modpackid}-gameversion`
            );
            ...
            if (
              version.value.length < 5 ||
              version.value.length > 255 ||
              /[<>:"\/\\\|?*\x00-\x1F]/g.test(version.value) ||
        ...
        content: [
          {
            ...
            title:
              req.language.dashboard.modpacks.content.addModpack.fields.version,
            classes: [],
          ...
          },
          {
            ...
            min: 1,
            title:
              req.language.dashboard.modpacks.content.addModpack.fields.bundle,
            classes: [],
            onChange: (languages, language, user) => (value) => {},
          },
        ],
