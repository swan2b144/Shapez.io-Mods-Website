        ...
        content: [
          {
            ...
            title:
              req.language.dashboard.modpacks.content.versions.fields.version,
            classes: [],
            value: version.id,
          ...
          },
          {
            ...
            min: 1,
            title:
              req.language.dashboard.modpacks.content.versions.fields.bundle,
            classes: [],
            onChange: (languages, language, user) => (value) => {},
          },
          {
            ...
            onChange: (languages, language, user) => async (value) => {
              ...
              let version = document.getElementById(
                `modpack-${modpackid}-version-${versionId}-name`
              );
              let gameversion = document.getElementById(
                `modpack-${modpackid}-version-${versionId}-gameversion`
              );
              let bundle = document.getElementById(
                `modpack-${modpackid}-version-${versionId}-bundle`
              );
              let index = document.getElementById(
                `modpack-${modpackid}-version-${versionId}-index`
              );
              ...
              xhr.onreadystatechange = async (e) => {
                if (e.target.readyState === XMLHttpRequest.DONE) {
                  if (e.target.status === 200)
                    window.location.href = `/dashboard/modpack-${modpackid}-${_id}-version-${version.value}`;
                }
              };
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            title:
              req.language.dashboard.modpacks.content.versions.fields.delete,
            classes: [],
            onChange: (languages, language, user) => (value) => {
              let fomeElements = document
                .getElementsByClassName("category active")[0]
              ...
              let id = document.getElementById(
                `modpack-${modpackid}-version-${versionId}-deleteName`
              );
              ...
              xhr.onreadystatechange = async (e) => {
                if (e.target.readyState === XMLHttpRequest.DONE) {
                  if (e.target.status === 200)
                    window.location.href = `/dashboard/modpack-${modpackid}-${_id}-versions`;
                }
              };
              xhr.send(JSON.stringify(data));
            },
