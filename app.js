...
app.listen(process.env.PORT, function () {
  console.log(
    `Node server running @ ${process.env.HOST}${
...
const baseLanguage = Object.freeze(
  require("./api/v1/languages/" + languages.baseLanguage + ".json")
);
...
app.use(async (req, res, next) => {
  ...
  if (req.user) {
    ...
    languages.matchDataRecursive(
      req.language,
      Object.freeze(
        require("./api/v1/languages/" + req.user.settings.language + ".json")
      )
    );
