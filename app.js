...
app.get('/showSignInPage',function(req,res){
    res.sendFile('signin.html',{'root': __dirname + '/html'});
});
app.get('/showSignInPageretry',function(req,res){
    res.sendFile('signinretry.html',{'root': __dirname + '/html'});
});
...
app.get('/showModsPage',function(req,res){
  res.sendFile('modsStore.html',{'root':__dirname + '/html'})
});
app.get('/showContactPage',function(req,res){
  res.sendFile('contact.html',{'root':__dirname + '/html'})
});
